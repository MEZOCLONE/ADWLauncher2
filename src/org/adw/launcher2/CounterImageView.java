...
public class CounterImageView extends ImageView {
    ...
    private void init(){
        ...
        final int fontSize = 1;//TODO:(int)(AlmostNexusSettingsHelper.getNotifSize(getContext()) * scale + 0.5f);
        ...
        mCounterPadding=2;//TODO:getContext().getResources().getDimensionPixelSize(R.dimen.counter_circle_padding);
    }
